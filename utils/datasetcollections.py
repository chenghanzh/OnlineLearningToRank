...
def get_datasets(sim_args):
    ...
    elif len(sim_args.data_sets) == 1 and sim_args.data_sets[0] == 'new_long':
        data_tags = [
            # 'MSLR-WEB30K',
            'istella'
            ]
    ...
    ##############################
    # local directories #
    elif len(sim_args.data_sets) == 1 and sim_args.data_sets[0] == 'new_local':
        data_tags = [
            'local_Webscope_C14_Set1',
            'local_Webscope_C14_Set2',
            'local_MSLR-WEB10K'
            # 'local_MSLR-WEB30K',
            # 'local_MQ2007',
            # 'local_HP2003',
    ...
    elif len(sim_args.data_sets) == 1 and sim_args.data_sets[0] == 'new_long_local':
        data_tags = [
            # 'local_MSLR-WEB30K',
            'local_istella'
            ]
    elif len(sim_args.data_sets) == 1 and sim_args.data_sets[0] == 'old_local':
        data_tags = [
            'local_MQ2007',
            'local_MQ2008',
            'local_HP2003',
...
DATASET_COLLECTION['local_istella'] = DataSet('istella',
                                            '../datasets/istella/', 'long', False, 220)
