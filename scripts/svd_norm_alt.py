...
# Created to make up for missing TD- based algorithms
...
run_name = 'svd_norm/svd_norm/P_DBGD_Wrapper2' 
...
# run_name = 'svd_norm/svd_norm/TD_DBGD_Wrapper' 
# rankers.append((run_name, TD_DBGD_Wrapper, other_args))

run_name = 'svd_norm/svd_norm/TD_MGD_Wrapper' 
...
run_name = 'svd_norm/qr_norm/P_DBGD_Wrapper2' 
rankers.append((run_name, P_DBGD_Wrapper, other_args))

run_name = 'svd_norm/qr_norm/P_MGD_Wrapper' 
rankers.append((run_name, P_MGD_Wrapper, other_args))

run_name = 'svd_norm/qr_norm/TD_DBGD_Wrapper' 
rankers.append((run_name, TD_DBGD_Wrapper, other_args))

run_name = 'svd_norm/qr_norm/TD_MGD_Wrapper' 
rankers.append((run_name, TD_MGD_Wrapper, other_args))
...
run_name = 'svd_norm/qr_no_norm/P_DBGD_Wrapper2' 
rankers.append((run_name, P_DBGD_Wrapper, other_args))

run_name = 'svd_norm/qr_no_norm/TD_MGD_Wrapper' 
rankers.append((run_name, TD_MGD_Wrapper, other_args))
