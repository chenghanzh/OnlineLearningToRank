...
run_name = 'wrappers/test_hist_viewed/15_P_DBGD_Wrapper' 
rankers.append((run_name, P_DBGD_Wrapper, other_args))
...
run_name = 'wrappers/test_hist_viewed/25_P_DBGD_Wrapper' 
rankers.append((run_name, P_DBGD_Wrapper, other_args))
...
run_name = 'wrappers/test_hist_viewed/5_P_DBGD_Wrapper' 
rankers.append((run_name, P_DBGD_Wrapper, other_args))
...
run_name = 'wrappers/test_hist_viewed/30_P_DBGD_Wrapper' 
rankers.append((run_name, P_DBGD_Wrapper, other_args))
...
run_name = 'wrappers/test_hist_viewed/50_P_DBGD_Wrapper' 
rankers.append((run_name, P_DBGD_Wrapper, other_args))
