...
run_name = 'wrappers/test_len_docspace/k3_P_MGD_Wrapper' 
...
run_name = 'wrappers/test_len_docspace/k3_P_DBGD_Wrapper' 
...
run_name = 'wrappers/test_len_docspace/0_P_DBGD_Wrapper' 
rankers.append((run_name, P_DBGD_Wrapper, other_args))
