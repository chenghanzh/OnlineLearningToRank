...
run_name = 'wrappers/test_len_docspace/1_P_MGD_Wrapper' 
...
run_name = 'wrappers/test_len_docspace/3_P_MGD_Wrapper' 
rankers.append((run_name, P_MGD_Wrapper, other_args))
...
run_name = 'wrappers/test_len_docspace/5_P_MGD_Wrapper' 
rankers.append((run_name, P_MGD_Wrapper, other_args))
