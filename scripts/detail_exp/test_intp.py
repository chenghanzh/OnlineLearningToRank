...
run_name = 'wrappers/test_intp/1_P_MGD_Wrapper' 
rankers.append((run_name, P_MGD_Wrapper, other_args))
...
run_name = 'wrappers/test_intp/3_P_MGD_Wrapper' 
rankers.append((run_name, P_MGD_Wrapper, other_args))
...
run_name = 'wrappers/test_intp/5_P_MGD_Wrapper' 
rankers.append((run_name, P_MGD_Wrapper, other_args))
...
run_name = 'wrappers/test_intp/7_P_MGD_Wrapper' 
rankers.append((run_name, P_MGD_Wrapper, other_args))
...
run_name = 'wrappers/test_intp/9_P_MGD_Wrapper' 
rankers.append((run_name, P_MGD_Wrapper, other_args))
