...
run_name = 'differential_privacy/DBGD_6/epsilon5_log' 
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/DBGD_6/epsilon10_log' 
rankers.append((run_name, P_DBGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/DBGD_6/epsilon1_log' 
rankers.append((run_name, P_DBGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/DBGD_7/epsilon5_log' 
rankers.append((run_name, P_DBGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/DBGD_7/epsilon10_log' 
rankers.append((run_name, P_DBGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/DBGD_7/epsilon1_log' 
rankers.append((run_name, P_DBGD_dp, other_args))
