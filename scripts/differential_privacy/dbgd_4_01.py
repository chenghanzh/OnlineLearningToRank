...
run_name = 'differential_privacy/DBGD_4/epsilon01_lr01' 
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/DBGD_4/epsilon1_lr01' 
rankers.append((run_name, P_DBGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/DBGD_4/epsilon5_lr01' 
rankers.append((run_name, P_DBGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/DBGD_4/epsilon10_lr01' 
rankers.append((run_name, P_DBGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/DBGD_4/epsilon05_lr01' 
rankers.append((run_name, P_DBGD_dp, other_args))
