...
run_name = 'differential_privacy/MGD_4/epsilon01_lr005' 
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/MGD_4/epsilon1_lr005' 
rankers.append((run_name, P_MGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/MGD_4/epsilon5_lr005' 
rankers.append((run_name, P_MGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/MGD_4/epsilon10_lr005' 
rankers.append((run_name, P_MGD_dp, other_args))
...
sim_args, other_args = parser.parse_all_args(ranker_params)
run_name = 'differential_privacy/MGD_4/epsilon05_lr005' 
rankers.append((run_name, P_MGD_dp, other_args))
